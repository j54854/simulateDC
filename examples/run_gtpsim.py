...
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    def dispatch_loop(self, loop, candidate_fw_tjobs):
        candidate_fw_tjobs = self.echelon_filter(candidate_fw_tjobs, Progress.ON_FW_LOOP)
...
# ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    ...
    for station in env.gtps.stations:
        print(f'Station {station.picker}: makespan {station.makespan:.2f} utilization {station.get_utilization():.4f}')
